...
const CATEGORIES = {
  ...
  flags: {
    ...
    code: 'FLAGS',
    questions: [
      { q: '🇸🇦 هذا علم أي دولة؟', a: ['الإمارات','السعودية','الكويت','قطر'], correct: 1 },
      { q: '🇺🇸 هذا علم أي دولة؟', a: ['كندا','بريطانيا','أمريكا','أستراليا'], correct: 2 },
      { q: '🇯🇵 هذا علم أي دولة؟', a: ['الصين','كوريا','اليابان','فيتنام'], correct: 2 },
      { q: '🇫🇷 هذا علم أي دولة؟', a: ['إيطاليا','فرنسا','ألمانيا','إسبانيا'], correct: 1 },
      { q: '🇧🇷 هذا علم أي دولة؟', a: ['الأرجنتين','البرازيل','المكسيك','كولومبيا'], correct: 1 },
      { q: '🇪🇬 هذا علم أي دولة؟', a: ['العراق','سوريا','مصر','اليمن'], correct: 2 },
      { q: '🇹🇷 هذا علم أي دولة؟', a: ['تركيا','تونس','باكستان','ماليزيا'], correct: 0 },
      { q: '🇩🇪 هذا علم أي دولة؟', a: ['بلجيكا','ألمانيا','هولندا','النمسا'], correct: 1 },
      { q: '🇰🇷 هذا علم أي دولة؟', a: ['اليابان','كوريا الشمالية','كوريا الجنوبية','تايوان'], correct: 2 },
      { q: '🇮🇳 هذا علم أي دولة؟', a: ['بنغلاديش','باكستان','الهند','نيبال'], correct: 2 },
      { q: '🇬🇧 هذا علم أي دولة؟', a: ['أستراليا','بريطانيا','نيوزيلندا','كندا'], correct: 1 },
      { q: '🇮🇹 هذا علم أي دولة؟', a: ['إيطاليا','أيرلندا','المكسيك','المجر'], correct: 0 },
      { q: '🇨🇦 هذا علم أي دولة؟', a: ['أمريكا','كندا','بريطانيا','أستراليا'], correct: 1 },
      { q: '🇦🇪 هذا علم أي دولة؟', a: ['الإمارات','عمان','الكويت','البحرين'], correct: 0 },
      { q: '🇮🇩 هذا علم أي دولة؟', a: ['بولندا','موناكو','إندونيسيا','ملطا'], correct: 2 },
    ]
  },
  higherlower: {
    name: '📊 أعلى / أدنى',
