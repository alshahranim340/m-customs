...
async function fetchNewsParallel() {
  ...
  // استراتيجية rss2json تنجح شبه دائماً، فهذا يمنع أخطاء CORS/403 المتوقعة
  // من باقي البروكسيات (corsproxy/allorigins/BBC) من الظهور بالكونسول كل مرة
  // بدون داعٍ — نفس نتيجة النجاح بالنهاية، بس بدون ضجيج.
  let firstError = null;
